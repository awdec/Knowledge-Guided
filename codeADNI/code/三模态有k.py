...
from model1 import CNN_3D, NiiDataset, NeuralNet, KGMultiModalTransformer, RotatEModel

from model1 import TransEModel
...
nii_folders = {"ad": "ad_nii_KG", "normal": "normal_nii_kg", "mci": "mci_nii_kg"}
...
X_train, X_val, y_train, y_val, transe_train, transe_val = train_test_split(
    X_train, y_train, transe_train, test_size=0.2, stratify=y_train, random_state=32
)
...
# rotate_model = RotatEModel(num_entities=764, num_relations=4, embed_dim=200)
